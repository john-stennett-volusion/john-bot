...
controller.hears('number', messageTypes, (bot, message) => {
	...
	if (numberMessage == '' || numberMessage == ' ' || numberMessage == 'random') {
		unirest.get(`https://numbersapi.p.mashape.com/random/trivia?fragment=true&json=true&max=20000&min=0`)
			.header('X-Mashape-Key', 'N6HhNVEoI1mshNub4YZLeKW1GDx0p1La1nojsnxney54j9lAo2')
			.header('Accept', 'text/plain')
			.end(function (result) {
		...
		unirest.get(`https://numbersapi.p.mashape.com/${numberMessage}/math?fragment=true&json=true`)
		.header('X-Mashape-Key', 'N6HhNVEoI1mshNub4YZLeKW1GDx0p1La1nojsnxney54j9lAo2')
		.header('Accept', 'text/plain')
		.end(function (result) {
...
controller.hears(['date'], messageTypes, (bot, message) => {
	...
	if (dateMessage.length == 2 && dateMessage[0] != '' && dateMessage[1] != '') {
		...
		unirest.get(`https://numbersapi.p.mashape.com/${MM}/${DD}/date?fragment=true&json=true`)
			.header('X-Mashape-Key', 'N6HhNVEoI1mshNub4YZLeKW1GDx0p1La1nojsnxney54j9lAo2')
			.header('Accept', 'text/plain')
			.end(function (result) {
